# Contributing to LlamaSpace

Thank you for your interest in contributing to LlamaSpace! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaSpace:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamaspace.git
   cd llamaspace
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamaspace.git
   ```
...
By contributing to LlamaSpace, you agree that your contributions will be licensed under the project's MIT License.
